...
- Source: [TMDB 5000 Movies Dataset](https://www.kaggle.com/datasets/tmdb/tmdb-movie-metadata) on Kaggle
- Two main files:
...
Python 3.8+
Libraries: pandas, numpy, scikit-learn, plotly, streamlit, scipy
